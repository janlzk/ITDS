exp_configuration={
    ...
    579:{
        ...
        'image_size':32,
        'class_num':10, 
        'eval_path':'eval_data/cifar10_data_c2000',
        ####### attack setting #######
        'targeted':True,
        'epsilon':16,
        'lr':1.6, # step size
        'steps':100, # max_iterations
        'di_prob':0.7,  # prob for DI and RE
        'resize_rate':0.5,   # resize rate for DI
        'DI_type':'g',
        'kn_name':'gaussian',  # kernel name
        'ks':5, # kernel size for TI
        'number_of_v_samples':5,
        'number_of_si_scales':5,
        'visualize':False,
        'mu':1.0,  # norm for grad
        ####################################
        # Admix
        'admix_portion':0.2, # 'Admix portion for the mixed image'
        'num_mix_samples':3, #  'Number of randomly sampled images'
        'extract_path':'eval_data/ImageNet_data_c2000/',
        'beta':1.5,
        'samples':200,
         # ODI params
        'shininess':0.5,
    ...
    580:{
        ...
        'image_size':32,
        'class_num':100, 
        'eval_path':'eval_data/cifar100_data_c2000',
        ####### attack setting #######
        'targeted':True,
        'epsilon':16,
        'lr':1.6, # step size
    ...
    581:{
        ...
        'image_size':64,
        'class_num':10, 
        'eval_path':'eval_data/stl10_data_c2000',
        ####### attack setting #######
        'targeted':True,
        'epsilon':16,
        'lr':1.6, # step size
        ...
        'admix_portion':0.2, # 'Admix portion for the mixed image'
        'num_mix_samples':3, #  'Number of randomly sampled images'
        'extract_path':'eval_data/stl10_data_c2000/',
        'beta':1.5,
        'samples':200,
         # ODI params
        'shininess':0.5,
